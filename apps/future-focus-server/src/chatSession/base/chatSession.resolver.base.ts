...
import { Counselor } from "../../counselor/base/Counselor";
...
export class ChatSessionResolverBase {
  ...
  async createChatSession(
    ...
    return await this.service.createChatSession({
      ...
      data: {
        ...
        counselor: args.data.counselor
          ? {
              connect: args.data.counselor,
            }
          : undefined,
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => Counselor, {
    nullable: true,
    name: "counselor",
  })
  @nestAccessControl.UseRoles({
  ...
  async getCounselor(
    @graphql.Parent() parent: ChatSession
  ): Promise<Counselor | null> {
    const result = await this.service.getCounselor(parent.id);
