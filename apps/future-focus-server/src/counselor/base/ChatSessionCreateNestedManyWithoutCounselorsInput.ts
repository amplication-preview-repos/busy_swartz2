...
@InputType()
class ChatSessionCreateNestedManyWithoutCounselorsInput {
...
export { ChatSessionCreateNestedManyWithoutCounselorsInput as ChatSessionCreateNestedManyWithoutCounselorsInput };
